...
<html>
	...
	<nav></nav>
		...
		<form action="signup_check.php" method="post">
			...
			<input type="password" name="pass" placeholder="Password mismatch, Try again." required>
			<input type="password" name="cpass" placeholder="Password mismatch, Try again." required><br>
